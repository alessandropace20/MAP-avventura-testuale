...
import com.mycompany.thediamondheist.impl.GameDesc;
import com.mycompany.thediamondheist.parser.Parser;
...
/**
 * Controller principale del gioco The Diamond Heist.
...
public class GameController {
    ...
    public GameController(boolean showIntro) {
        ...
        observers.add(new com.mycompany.thediamondheist.impl.MoveObserver());
        observers.add(new com.mycompany.thediamondheist.impl.OpenObserver());
        observers.add(new com.mycompany.thediamondheist.impl.UseObserver());
        observers.add(new com.mycompany.thediamondheist.impl.PickUpObserver());

        observers.add(new com.mycompany.thediamondheist.impl.LookObserver());
        observers.add(new com.mycompany.thediamondheist.impl.InventoryObserver());
        observers.add(new com.mycompany.thediamondheist.impl.HelpObserver());

        observers.add(new com.mycompany.thediamondheist.impl.EndObserver());
    ...
    private File getSaveFile() {
        File dir = new File(System.getProperty("user.home"), ".thediamondheist");
    ...
    private void loadFromSerialized(String data) {
        ...
        try {
            ...
            Room r = switch (id) {
                ...
                case 4 -> g.getCorridoioPrincipale();
                case 5 -> g.getZonaSensori();
                case 6 -> g.getCaveau();
                case 7 -> g.getUscita();
